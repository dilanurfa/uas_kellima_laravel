...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-muted text-center mt-3 mb-0">
          Belum punya akun?
          <a href="<?php echo e(route('register')); ?>" class="text-theme ml-1">Daftar di sini</a>
        </p>
      </div> <!-- .col -->
    </div> <!-- .row -->
  </div> <!-- .container -->
...
<?php /**PATH C:\Users\ASUS VIVOBOOK DC\uas_kellima_laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>