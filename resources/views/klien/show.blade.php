    ...
    <div class="receipt-card">
      ...
      <div class="receipt-body">
        ...
        <div class="text-center mt-4">
          ...
          <a href="{{ route('booking.download', $booking->id) }}" class="btn btn-outline-secondary btn-custom">
